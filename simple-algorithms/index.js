...
function maxOfTwoNumbers(num1, num2) {
  // TODO:
  // Vergleichen: ist num1 größer als num2
  // Fall 1: Wenn num1 größer ist, dann git num1 zurück
  // Fall 2: Wenn num2 größer oder gleich ist, git num2 zurück
...
function howManyTimes(haystack, needle) {
  // TODO:
  // Variable an legen die 0 ist
  // jedes Element in haystack durch gehen
  // jedes Element mit needle vergleichen
  // Wenn ja, die Variable um 1 erhöhen
  // Zähler zurück geben
...
function greatestProduct(matrix) {
  ...
  for (let i = 0; i < matrix.length; i++) {
    for (let j = 0; i < matrix[i].length - 3; j++) {
      const product =
